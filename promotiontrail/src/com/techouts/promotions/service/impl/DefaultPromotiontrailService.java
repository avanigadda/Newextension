...
public class DefaultPromotiontrailService implements PromotiontrailService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultPromotiontrailService.class);
	...
	{
		return DefaultPromotiontrailService.class.getResourceAsStream("/promotiontrail/sap-hybris-platform.png");
	}
