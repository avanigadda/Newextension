 ...
 */
package com.techouts.promotions.jalo;
...
/**
 * This is the extension manager of the Promotiontrail extension.
 */
public class PromotiontrailManager extends GeneratedPromotiontrailManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(PromotiontrailManager.class);
	 ...
	 */
	public static PromotiontrailManager getInstance()
	{
		return (PromotiontrailManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PromotiontrailConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PromotiontrailManager() // NOPMD 
	{
		LOG.debug("constructor of PromotiontrailManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of PromotiontrailManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of PromotiontrailManager called, current tenant: {}", getTenant().getTenantID());
	}
